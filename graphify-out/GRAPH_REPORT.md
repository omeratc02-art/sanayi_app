...
## Corpus Check
- 198 files · ~186,536 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2493 nodes · 3524 edges · 157 communities (127 shown, 25 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ce18f51e`
...
- mechanic_profile_repository_test.dart
- greeting_bar.dart
...
9. `scripts` - 9 edges
10. `Steps 6b-8: Wiki, Neo4j, FalkorDB, SVG, GraphML, MCP, benchmark` - 9 edges
...
Cohesion: 0.11
Nodes (19): AppointmentRequest get, customer_conversation_page.dart, _acceptSuggestion, AppointmentDetailPage, _AppointmentDetailPageState, createState, _DetailRow, _DetailStatusPill (+11 more)

### Community 8 - "generate_adaptive_foreground.dart"
Cohesion: 0.05
Nodes (42): dart:collection, package:image/image.dart, bg, _bgThreshold, counts, file, filledCount, image (+34 more)
...
Cohesion: 0.03
Nodes (58): ../home/mechanic_home_page.dart, _afterSignedIn, batch, build, businessId, _businessNameController, _BusinessOptionLabel, _cancel (+50 more)
...
Cohesion: 0.06
Nodes (31): ../appointments/appointments_tab.dart, ../appointments/customer_conversation_list_page.dart, ../categories/ac_climate_category_page.dart, ../categories/battery_electrical_category_page.dart, ../categories/body_paint_category_page.dart, ../categories/brake_system_category_page.dart, ../categories/exhaust_system_category_page.dart, ../categories/glass_lighting_category_page.dart (+23 more)

### Community 21 - "search_tab.dart"
Cohesion: 0.10
Nodes (20): build, _controller, createState, dispose, _filteredResults, _future, initialCategory, initState (+12 more)

### Community 22 - "mechanic_home_screen.dart"
Cohesion: 0.03
Nodes (66): ../appointments/mechanic_request_details_page.dart, dart:math, appointmentDate, _appointmentRepository, appointmentRequestCount, build, businessName, createdAt (+58 more)
...
Cohesion: 0.09
Nodes (22): ../../data/booking_history.dart, build, count, createState, distribution, _DistributionRow, _filter, _FilterRow (+14 more)

### Community 32 - "IconData"
Cohesion: 0.12
Nodes (14): IconData, icon, label, ServiceCategory, subtitle, build, icon, label (+6 more)

### Community 33 - "appointment_repository.dart"
Cohesion: 0.08
Nodes (23): appointment.dart, acceptProposedTime, acceptTimeProposal, AppointmentRepository, _collection, fetchAppointmentById, fetchAppointments, fetchOnTimeCompletionRate (+15 more)

### Community 34 - "appointment_request.dart"
Cohesion: 0.15
...
Cohesion: 0.09
Nodes (22): chatId, _ConversationRow, createState, CustomerConversationListPage, _CustomerConversationListPageState, _EmptyState, _fillColor, _FilterChip (+14 more)
...
Cohesion: 0.10
Nodes (21): _EmptyTabState, _InfoRow, _NewRequestBadge, _NewRequestCard, _ServiceBadge, _SuggestInfoRow, _TimelineRow, _ActionBar (+13 more)

### Community 38 - "chat_message.dart"
Cohesion: 0.12
...
Cohesion: 0.09
Nodes (23): ../booking/appointment_request_page.dart, build, createState, icon, _InfoCard, initState, mechanic, MechanicDetailPage (+15 more)

### Community 42 - "booking_test.dart"
Cohesion: 0.16
Nodes (12): ElevatedButton, package:sanayi_app/data/pending_booking_vehicle.dart, package:sanayi_app/models/mechanic.dart, package:sanayi_app/screens/booking/appointment_request_page.dart, package:sanayi_app/screens/mechanic_detail/mechanic_detail_page.dart, package:sanayi_app/widgets/booking/date_strip.dart, main, openRequestPageForHizliLastikci (+4 more)

### Community 43 - "MaterialPageRoute"
Cohesion: 0.11
Nodes (19): _openMechanicDetail, build, build, build, build, _openAppointments, _openNotifications, _openRequestDetails (+11 more)

### Community 44 - "package:flutter_test/flutter_test.dart"
Cohesion: 0.13
Nodes (21): package:firebase_auth_mocks/firebase_auth_mocks.dart, package:flutter_test/flutter_test.dart, package:google_sign_in_platform_interface/google_sign_in_platform_interface.dart, package:sanayi_app/main.dart, package:sanayi_app/mechanic/home/mechanic_home_page.dart, package:sanayi_app/screens/auth/login_page.dart, package:sanayi_app/screens/home/all_vehicles_page.dart, package:sanayi_app/screens/home/main_shell.dart (+13 more)
...
### Community 47 - "request_another_time_sheet.dart"
Cohesion: 0.18
...
Cohesion: 0.11
Nodes (19): ../../admin/admin_approval_screen.dart, ../../admin/data/admin_repository.dart, _adminTapThreshold, _adminTapWindow, build, createState, CustomerProfileTab, _CustomerProfileTabState (+11 more)
...
Cohesion: 0.13
Nodes (15): AnimationController, double?, _avatarSize, borderRadius, build, _controller, count, createState (+7 more)
...
### Community 60 - "mechanic_profile.dart"
Cohesion: 0.13
Nodes (14): int?, address, businessId, businessName, email, fromFirestore, hizmetler, isVerified (+6 more)

### Community 61 - "date_strip.dart"
Cohesion: 0.25
Nodes (7): DateTime, build, dates, DateStrip, onSelected, selected, ../../utils/turkish_date.dart
...
### Community 64 - "review.dart"
Cohesion: 0.25
Nodes (7): authorName, comment, date, hasPhoto, helpfulCount, rating, Review

### Community 65 - "mechanic_profile_screen.dart"
Cohesion: 0.06
Nodes (33): data/mechanic_profile.dart, data/mechanic_profile_repository.dart, address, build, businessId, businessName, _collapsedCount, color (+25 more)
...
Cohesion: 0.25
Nodes (7): fetchProfile, fetchRepeatCustomerCount, fetchRepeatCustomerRate, _firestore, recordProfileView, watchProfileViewCount, mechanic_profile.dart

### Community 70 - "List"
Cohesion: 0.14
Nodes (12): formatFullDate, isSameDay, _monthFull, _weekdayFull, _weekdayShort, build, onSelected, selected (+4 more)
...
### Community 77 - "../../utils/firebase_instances.dart"
Cohesion: 0.33
...
### Community 78 - "body_paint_category_page.dart"
Cohesion: 0.33
...
Cohesion: 0.17
Nodes (10): BrakeSystemCategoryPage, build, _cardSpacing, onServiceSelected, _services, build, CategoryFilterBar, onSelected (+2 more)
...
### Community 90 - "static const"
Cohesion: 0.11
Nodes (17): AcClimateCategoryPage, build, _cardSpacing, onServiceSelected, _services, build, _cardSpacing, GlassLightingCategoryPage (+9 more)
...
### Community 93 - "oil_change_category_page.dart"
Cohesion: 0.33
...
### Community 95 - "service_listing_page.dart"
Cohesion: 0.15
Nodes (13): ../../data/mechanic_directory_repository.dart, Future, build, createState, _fetchSortedServiceCenters, _future, hizmetTuru, initState (+5 more)
...
### Community 101 - "mechanic_profile_repository_test.dart"
Cohesion: 0.22
Nodes (8): FakeFirebaseFirestore, MechanicProfileRepository, package:sanayi_app/mechanic/profile/data/mechanic_profile_repository.dart, currentCount, firestore, main, repository, seedBusiness
...
### Community 103 - "firebase_instances.dart"
Cohesion: 0.40
Nodes (4): FirebaseAuth, firebaseAuthInstance, firestoreInstance, package:firebase_auth/firebase_auth.dart

### Community 104 - "State"
Cohesion: 0.15
Nodes (18): AdminApprovalScreen, _AdminApprovalScreenState, _TypingIndicator, _BusinessPickerDialog, _BusinessPickerDialogState, _MechanicAuthDialog, _MechanicAuthDialogState, MechanicLoginPage (+10 more)

### Community 105 - "SingleTickerProviderStateMixin"
Cohesion: 0.67
Nodes (4): _TypingIndicatorState, _TypingIndicatorState, SingleTickerProviderStateMixin, _TypingIndicator

### Community 106 - "exhaust_system_category_page.dart"
Cohesion: 0.33
Nodes (5): build, _cardSpacing, ExhaustSystemCategoryPage, onServiceSelected, _services

### Community 107 - "motor_category_page.dart"
Cohesion: 0.33
Nodes (5): build, _cardSpacing, MotorCategoryPage, onServiceSelected, _services

### Community 108 - "mechanic_home_screen_test.dart"
Cohesion: 0.12
Nodes (15): Badge, dart:io, Icon, package:sanayi_app/mechanic/home/mechanic_home_screen.dart, package:sanayi_app/theme/app_theme.dart, RawImage, businessId, daysFromNow (+7 more)
...
Cohesion: 0.22
Nodes (7): BatteryElectricalCategoryPage, build, _cardSpacing, onServiceSelected, _services, showTrustInfoSheet, ../../theme/app_theme.dart

### Community 113 - "section_label.dart"
Cohesion: 0.50
Nodes (3): build, SectionLabel, text
...
Cohesion: 0.22
Nodes (8): package:sanayi_app/mechanic/profile/mechanic_profile_screen.dart, package:sanayi_app/widgets/common/premium_surface.dart, businessId, main, pumpScreen, seedCompletedAppointment, seedProfile, uid

### Community 125 - "category_grid_test.dart"
Cohesion: 0.14
Nodes (13): package:sanayi_app/screens/categories/ac_climate_category_page.dart, package:sanayi_app/screens/categories/motor_category_page.dart, package:sanayi_app/screens/categories/periodic_maintenance_category_page.dart, package:sanayi_app/screens/categories/tire_wheel_category_page.dart, package:sanayi_app/screens/home/home_tab.dart, package:sanayi_app/screens/home/vehicle_repair_category_page.dart, package:sanayi_app/screens/search/search_tab.dart, package:sanayi_app/screens/service_listing/service_listing_page.dart (+5 more)
...
### Community 127 - "suspension_steering_category_page.dart"
Cohesion: 0.33
Nodes (5): build, _cardSpacing, onServiceSelected, _services, SuspensionSteeringCategoryPage

### Community 128 - "open_status_badge.dart"
Cohesion: 0.50
Nodes (3): build, isOpen, OpenStatusBadge

### Community 129 - "periodic_maintenance_category_page.dart"
Cohesion: 0.33
...
### Community 143 - "tire_wheel_category_page.dart"
Cohesion: 0.33
Nodes (5): build, _cardSpacing, onServiceSelected, _services, TireWheelCategoryPage

### Community 144 - "all_vehicles_page.dart"
Cohesion: 0.25
...
Cohesion: 0.33
Nodes (5): date, now, time, today, package:flutter/material.dart

### Community 149 - "_BusinessOption"
Cohesion: 0.67
...
## Knowledge Gaps
- **1545 isolated node(s):** `uid`, `businessId`, `businessName`, `email`, `phone` (+1540 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 1747 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
...
- **Why does `_` connect `_` to `firebase_instances.dart`, `chat_repository.dart`, `../../utils/firebase_instances.dart`, `mechanic.dart`, `google_sign_in_button_stub.dart`, `pending_booking_vehicle.dart`?**
...
- **Why does `Mechanic` connect `mechanic_list_tile.dart` to `appointment_request_page.dart`, `customer_conversation_list_page.dart`, `customer_conversation_page.dart`, `service_center_card.dart`, `mechanic_login_page.dart`, `mechanic.dart`, `reviews_page.dart`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **What connects `uid`, `businessId`, `businessName` to the rest of the system?**
